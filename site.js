// MIRKO IZOBASALT — vanilla JavaScript version
// Converted from the original React/TypeScript project without changing the site's content or visual CSS.
...
const MIRKO_COPY = {
  ru: {
    ...
    "hero.line1": "Базальтовая",
"hero.line2": "теплоизоляция.",
"hero.line3": "Тепло. Тишина. Защита.",
    "home.productDescription": "Минеральная теплоизоляция для частного, коммерческого и промышленного строительства.",
    "hero.description": "Профессиональная базальтовая теплоизоляция для частных домов, коммерческих и промышленных объектов.",
    "fire.eyebrow": "Огнестойкость",
    "fire.title1": "ОГОНЬ —",
    "fire.title2": "НЕ ЧАСТЬ",
    "fire.title3": "ИСТОРИИ.",
    "fire.description": "Базальтовая изоляция не поддерживает горение и предназначена для повышения пожарной безопасности строительных конструкций.",
    "fire.point1": "НЕ ГОРИТ",
    "fire.point2": "НЕ ПОДДЕРЖИВАЕТ ГОРЕНИЕ",
    "fire.point3": "ОГНЕСТОЙКОЕ РЕШЕНИЕ",
    "fire.link": "Технология производства",
    "reviews.review1": "«Материал хорошо показывает себя в работе. Удобно укладывается, а главное — хорошо сохраняет температуру.»",
"reviews.author1": "Александр",
"reviews.type1": "Частный дом",

"reviews.review2": "«Использовали базальтовую изоляцию для утепления кровли. Материал плотный, удобный в монтаже и хорошо подходит для строительных работ.»",
"reviews.author2": "Рустам",
"reviews.type2": "Строительная компания",

"reviews.review3": "«Для нас было важно получить нормальную теплоизоляцию без сложного монтажа. MIRKO IZOBASALT подошёл по формату и характеристикам.»",
"reviews.author3": "Мухаммад",
"reviews.type3": "Коммерческий объект",
"cta.eyebrow": "Начнём с расчёта",
"cta.title1": "Ваш объект.",
"cta.title2": "Наше тепло.",
"cta.description": "Рассчитайте необходимое количество листов или свяжитесь с нами для консультации.",
"cta.calculate": "Рассчитать материал",
"cta.contact": "Связаться с нами",
    "home.applicationsDescription": "Подбираем плотность и объём под задачу проекта. Окончательное применение подтверждается специалистом.",  
    ...
    "form.name": "Ваше имя", "form.namePlaceholder": "Как к вам обращаться?", "form.phone": "Телефон", "form.region": "Регион", "form.regionPlaceholder": "Например, Фергана", "form.project": "Тип объекта", "form.message": "О проекте", "form.messagePlaceholder": "Площадь, сроки или другие детали", "form.submit": "Отправить заявку", "form.consent": "Нажимая кнопку, вы соглашаетесь с политикой конфиденциальности.", "form.attached": "Расчёт прикреплён", "form.sheets": "Количество", "form.subject": "Заявка с сайта MIRKO IZOBASALT", "form.emailName": "Имя", "form.emailRegion": "Регион", "form.emailObject": "Объект", "form.emailComment": "Комментарий",
    ...
    "calc.area": "Площадь проекта", "calc.density": "Плотность", "calc.volume": "Необходимое количество", "calc.packs": "пачек", "calc.unit": "шт.", "calc.coverage": "Покрытие", "calc.reserveLabel": "Запас", "calc.reserve": "м² с технологическим запасом 8%", "calc.price": "Узнать стоимость", "calc.note": "Точная цена подтверждается менеджером.",
  ...
  uz: {
    "nav.product": "Mahsulot", "nav.technology": "Texnologiya", "nav.projects": "Loyihalar", "nav.factory": "Kompaniya", "nav.contact": "Aloqa","home.productDescription": "Xususiy, tijorat va sanoat qurilishi uchun mineral issiqlik izolyatsiyasi.",
    "action.quote": "Hisob-kitob olish", "menu.open": "Menyuni ochish", "language.label": "Tilni tanlash",
    "home.applicationsDescription": "Loyiha vazifasiga qarab zichlik va hajmni tanlaymiz. Yakuniy qo‘llash sohasi mutaxassis tomonidan tasdiqlanadi.",
    "hero.location": "FARG‘ONA / O‘ZBEKISTON", "hero.kicker": "Yangi avlod mineral issiqlik izolyatsiyasi",
    "fire.eyebrow": "Yong‘inga chidamlilik",
    "fire.title1": "YONG‘IN —",
    "fire.title2": "BU YERDA",
    "fire.title3": "O‘RIN YO‘Q.",
    "fire.description": "Bazalt izolyatsiyasi yonishni qo‘llab-quvvatlamaydi va qurilish konstruksiyalarining yong‘in xavfsizligini oshirish uchun mo‘ljallangan.",
    "fire.point1": "YONMAYDI",
    "fire.point2": "YONISHNI QO‘LLAB-QUVVATLAMAYDI",
    "fire.point3": "YONG‘INGA CHIDAMLI YECHIM",
    "fire.link": "Ishlab chiqarish texnologiyasi",
    "reviews.review1": "«Material ish jarayonida o‘zini yaxshi ko‘rsatadi. O‘rnatish qulay, eng muhimi — haroratni yaxshi saqlaydi.»",
"reviews.author1": "Aleksandr",
"reviews.type1": "Xususiy uy",

"reviews.review2": "«Tomni izolyatsiyalash uchun bazalt izolyatsiyasidan foydalandik. Material zich, o‘rnatish qulay va qurilish ishlari uchun juda mos.»",
"reviews.author2": "Rustam",
"reviews.type2": "Qurilish kompaniyasi",

"reviews.review3": "«Biz uchun murakkab montajsiz sifatli issiqlik izolyatsiyasini olish muhim edi. MIRKO IZOBASALT formati va xususiyatlari bilan bizga mos keldi.»",
"reviews.author3": "Muhammad",
"reviews.type3": "Tijorat obyekti",
"cta.eyebrow": "Hisob-kitobdan boshlaymiz",
"cta.title1": "Sizning obyektingiz.",
"cta.title2": "Bizning issiqligimiz.",
"cta.description": "Kerakli listlar sonini hisoblang yoki maslahat uchun biz bilan bog‘laning.",
"cta.calculate": "Materialni hisoblash",
"cta.contact": "Biz bilan bog‘lanish",
    "hero.line1": "Bazalt", "hero.line2": "issiqlik izolyatsiyasi.", "hero.line3": "Issiqlik. Sokinlik. Himoya.",
    ...
    "calc.area": "Loyiha maydoni", "calc.density": "Zichlik", "calc.volume": "Kerakli miqdor", "calc.packs": "qadoq", "calc.unit": "dona", "calc.coverage": "Qoplama", "calc.reserveLabel": "Zaxira", "calc.reserve": "m², 8% texnologik zaxira bilan", "calc.price": "Narxni bilish", "calc.note": "Aniq narxni menejer tasdiqlaydi.",
  ...
  en: {
    ...
    "action.quote": "Request estimate", "menu.open": "Open menu", "language.label": "Choose language","home.productDescription": "Mineral thermal insulation for residential, commercial and industrial construction.",
    "hero.location": "FERGANA / UZBEKISTAN", "hero.kicker": "A new generation of mineral insulation",
    "fire.eyebrow": "Fire resistance",
    "fire.title1": "FIRE —",
    "fire.title2": "HAS NO",
    "fire.title3": "PLACE HERE.",
    "fire.description": "Basalt insulation does not support combustion and is designed to improve the fire safety of building structures.",
    "fire.point1": "DOES NOT BURN",
    "fire.point2": "DOES NOT SUPPORT COMBUSTION",
    "fire.point3": "FIRE-RESISTANT SOLUTION",
    "fire.link": "Production technology",
    "reviews.review1": "“The material performs well in practice. It is easy to install and, most importantly, keeps the temperature stable.”",
"reviews.author1": "Alexander",
"reviews.type1": "Private home",

"reviews.review2": "“We used basalt insulation for roof insulation. The material is dense, easy to install and well suited for construction work.”",
"reviews.author2": "Rustam",
"reviews.type2": "Construction company",

"reviews.review3": "“It was important for us to get reliable thermal insulation without complicated installation. MIRKO IZOBASALT matched our project in both format and specifications.”",
"reviews.author3": "Muhammad",
"reviews.type3": "Commercial project",
"cta.eyebrow": "Let's start with a calculation",
"cta.title1": "Your project.",
"cta.title2": "Our warmth.",
"cta.description": "Calculate the required number of sheets or contact us for a consultation.",
"cta.calculate": "Calculate material",
"cta.contact": "Contact us",
    "home.applicationsDescription": "We select density and volume for the project. Final application is confirmed by a specialist.",
    "hero.line1": "Basalt", "hero.line2": "thermal insulation.", "hero.line3": "Warmth. Quiet. Protection.",
    ...
    "form.name": "Your name", "form.namePlaceholder": "How should we address you?", "form.phone": "Phone", "form.region": "Region", "form.regionPlaceholder": "For example, Fergana", "form.project": "Project type", "form.message": "About the project", "form.messagePlaceholder": "Area, schedule or other details", "form.submit": "Send request", "form.consent": "By submitting, you agree to the privacy policy.", "form.attached": "Estimate attached", "form.sheets": "Quantity", "form.subject": "Request from the MIRKO IZOBASALT website", "form.emailName": "Name", "form.emailRegion": "Region", "form.emailObject": "Project", "form.emailComment": "Comment",
    ...
    "calc.area": "Project area", "calc.density": "Density", "calc.volume": "Required quantity", "calc.packs": "packs", "calc.unit": "pcs.", "calc.coverage": "Coverage", "calc.reserveLabel": "Reserve", "calc.reserve": "m² including an 8% installation reserve", "calc.price": "Request price", "calc.note": "Final pricing is confirmed by a manager.",
...
const MIRKO_TRANSLATIONS = new Map();
for (const row of MIRKO_TRANSLATION_ROWS) {
  for (const value of [row.ru, row.uz, row.en]) MIRKO_TRANSLATIONS.set(value, row);
}

const MIRKO_PATTERN = new RegExp(
  [...MIRKO_TRANSLATIONS.keys()]
...
function mirkoLocalize(value, language) {
  if (!value) return value;
  return value.replace(MIRKO_PATTERN, match => MIRKO_TRANSLATIONS.get(match)?.[language] ?? match);
}
...
function translateDocument(language) {
  const copy = MIRKO_COPY[language] || MIRKO_COPY.ru;

  // 1) Explicit keys always win. This keeps buttons/labels with child icons intact.
  document.querySelectorAll('[data-i18n]').forEach(element => {
    const key = element.dataset.i18n;
    const value = copy[key];
    if (value != null) setI18nText(element, value);
  });

  // 2) Translate remaining visible text, including header and footer.
  const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT);
  let node = walker.nextNode();
  while (node) {
    const parent = node.parentElement;
    const insideExplicitKey = parent?.closest?.('[data-i18n]');
    if (
      parent &&
      !insideExplicitKey &&
      ...
      node.nodeValue = mirkoLocalize(node.nodeValue, language);
    }
    node = walker.nextNode();
  }

  // 3) Translate accessibility and form attributes.
  document.querySelectorAll('[alt],[aria-label],[title],[placeholder]').forEach(element => {
    for (const attr of ['alt', 'aria-label', 'title', 'placeholder']) {
      ...
      if (!value) continue;
      element.setAttribute(attr, mirkoLocalize(value, language));
    }
  });

  // 4) Translate page metadata where matching copy exists in the fallback dictionary.
  document.title = mirkoLocalize(document.title, language);
  document.querySelectorAll('meta[name="description"], meta[property="og:title"], meta[property="og:description"]').forEach(meta => {
    const value = meta.getAttribute('content');
    if (value) meta.setAttribute('content', mirkoLocalize(value, language));
  });
}

function setLanguage(language) {
  if (!MIRKO_COPY[language]) return;
  document.documentElement.lang = language;
  localStorage.setItem("mirko-language", language);

  document.querySelectorAll("[data-lang]").forEach(btn => {
    btn.classList.toggle("is-active", btn.dataset.lang === language);
    btn.setAttribute("aria-pressed", btn.dataset.lang === language ? "true" : "false");
  });

  // Rebuild from the original Russian/HTML copy before applying a new translation.
  // This prevents RU → UZ → EN from progressively corrupting the text.
...
document.addEventListener("DOMContentLoaded", () => {
  const saved = localStorage.getItem("mirko-language");
  const language = saved && MIRKO_COPY[saved] ? saved : "ru";

  // The original React app starts in RU and then restores the saved language.
  if (language !== "ru") {
...
function initCalculator() {
  document.querySelectorAll('.calculator').forEach(calc => {
    const area = calc.querySelector('input[type="number"]');
    const quantityEl = calc.querySelector('.calculator-result strong');
    const coverageEl = calc.querySelector('.calculator-result p');
    const quote = calc.querySelector('.calculator-result a.button');

    if (!area || !quantityEl || !coverageEl || !quote) return;

    const SHEET_AREA = 0.72;
    const RESERVE = 1.08;
    const language = document.documentElement.lang || 'ru';
    const t = MIRKO_COPY[language] || MIRKO_COPY.ru;

    const update = () => {
      const value = Math.max(0, Number(area.value) || 0);
      const sheets = Math.max(1, Math.ceil((value * RESERVE) / SHEET_AREA - 0.000001));
      const actualCoverage = (sheets * SHEET_AREA).toFixed(2);

      quantityEl.innerHTML = `${sheets}<small>${t['calc.unit']}</small>`;
      coverageEl.innerHTML = `
        <span>${t['calc.coverage']}: <strong>${actualCoverage} м²</strong></span>
        <span>${t['calc.reserveLabel']}: <strong>8%</strong></span>
      `;

      const base = quote.getAttribute('href')?.split('?')[0] || '../contact/';
      const prefix = base.endsWith('/') ? base : `${base}/`;
      quote.href = `${prefix}?area=${encodeURIComponent(value)}&sheets=${sheets}#request`;
    };
...
function initLeadForms() {
  document.querySelectorAll(".lead-form,.review-form").forEach(form => {
    form.addEventListener("submit", event => {
      ...
      if (form.classList.contains("lead-form")) {
        const t = MIRKO_COPY[lang];
        const params = new URLSearchParams(location.search);
        const attachedParts = [];
        if (params.get("area")) attachedParts.push(`${params.get("area")} м²`);
        if (params.get("density")) attachedParts.push(`${t["calc.density"]}: ${params.get("density")} кг/м³`);
        if (params.get("sheets")) attachedParts.push(`${t["form.sheets"]}: ${params.get("sheets")} ${t["calc.unit"]}`);
        if (!params.get("sheets") && params.get("packs")) attachedParts.push(`${t["calc.packs"]}: ${params.get("packs")}`);
        const attached = attachedParts.length ? `${t["form.attached"]}: ${attachedParts.join("; ")}.` : "";
        const body = [
        ...
        location.href = `mailto:mircoizobazalt@gmail.com?subject=${encodeURIComponent(t["form.subject"])}&body=${encodeURIComponent(body)}`;
      } else {
        const t = MIRKO_COPY[lang];
        const body = [
        ...
        location.href = `mailto:mircoizobazalt@gmail.com?subject=${encodeURIComponent(t["review.subject"])}&body=${encodeURIComponent(body)}`;
      }
    });
  });
}
...
function initHero() {
  ...
  const stage = hero.querySelector(".mv-stage");
  const model = hero.querySelector("model-viewer");
  const progressBar = hero.querySelector(".mv-footer-nav > div i");
  if (!stage) return;

  const clamp = (v,min=0,max=1) => Math.min(max,Math.max(min,v));
  const mix = (a,b,t) => a+(b-a)*t;
  const orbitAngle = progress => {
    if (progress < .24) return mix(192,130,progress/.24);
    if (progress < .5) return mix(130,78,(progress-.24)/.26);
    if (progress < .76) return mix(78,192,(progress-.5)/.26);
    return mix(192,266,(progress-.76)/.24);
  };
  ...
  const update = () => {
    ...
    hero.style.setProperty("--mv-progress", progress);
    hero.dataset.phase = progress < .24 ? "0" : progress < .5 ? "1" : progress < .76 ? "2" : "3";
    if (progressBar) progressBar.style.transform = `scaleX(${progress})`;

    if (model && customElements.get("model-viewer")) {
      const theta = orbitAngle(progress);
      const phi = 76 - Math.sin(progress * Math.PI) * 11;
      const radius = 92 - Math.sin(progress * Math.PI) * 9;
      model.setAttribute("camera-orbit", `${theta}deg ${phi}deg ${radius}%`);
    }
  };
  ...
  const chapterStops = [0,.255,.515,.775,1];
  let wheelLock = false;
  let unlockTimer = 0;
  hero.addEventListener("wheel", event => {
    if (matchMedia("(prefers-reduced-motion: reduce)").matches || !matchMedia("(pointer:fine)").matches || Math.abs(event.deltaY) < 4) return;
    const rect = hero.getBoundingClientRect();
    const distance = Math.max(1, hero.offsetHeight-innerHeight);
    const current = clamp(-rect.top/distance);
    const direction = Math.sign(event.deltaY);
    if ((direction < 0 && current <= .015) || (direction > 0 && current >= .985)) return;
    event.preventDefault();
    clearTimeout(unlockTimer);
    unlockTimer = setTimeout(() => wheelLock=false,220);
    if (wheelLock) return;
    wheelLock=true;
    const target = direction > 0
      ? chapterStops.find(stop => stop > current+.045)
      : [...chapterStops].reverse().find(stop => stop < current-.045);
    if (target === undefined) { wheelLock=false; return; }
    const top = scrollY + rect.top;
    scrollTo({top: top + target*distance, behavior:"smooth"});
  }, {passive:false});
}

// Keep the original 3D model dependency, but make it optional.
// If it is unavailable, the original static product image remains visible.
...
const productDataGrid = document.querySelector('.product-data-grid');

if (productDataGrid) {
  const productDataObserver = new IntersectionObserver(
    (entries, observer) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          productDataGrid.classList.add('is-visible');
          observer.unobserve(productDataGrid);
        }
      });
    },
    {
  ...
  productDataObserver.observe(productDataGrid);
}